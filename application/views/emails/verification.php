                                        ...
                                        <td class="content-cell">
                                            <div class="f-fallback">
                                              <div style="width: 100%; margin-bottom: 10px; text-align: center;">
																								<h1 style="width: 100%; margin-bottom: 10px; text-align: center;">{Sitename}</h1>
                                              </div>
                                              ...
                                              <h2 style="font-size: 20px;">Dear {newUsername},</h2>
                                              <p>Welcome to <a title="HHR SPACE" target="_blank" href="<?php echo base_url() ?>">{Sitename}</a>. We'd love to make sure we've got the right email for you.</p>
                                              <br>
                                              <p>Your verification code is <b style="cursor: pointer;" ><u>{verificationCode}</u></b></p>
																							<br>
																							<p>To verify your email <a href="{URL}">Click Here</a></p>
																							<br>
																							<p>Please note that this verification code is valid only next one hour.</p>
                                ...
                                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="content-cell" align="center">
                                            <p class="f-fallback sub align-center">&copy; {Sitename}. All rights reserved.</p>
